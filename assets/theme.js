...
function initProductForm() {
  ...
  if(selectors.sizeChartBtn) {
    ...
    selectors.sizeChartBtn.addEventListener('click', () => {
      sizeGuidePopup.classList.remove('popup__hidden');
  ...
  function preloadProductModal(handle, productId) {
    ...
    .then(function(data) {
      ...
      if (selectors.quickViewContainer) {
        ...
        document.querySelector('.quick-view__container .product__sizeguide').classList.add('hidden');
        document.querySelector('.quick-view__container .shopify-payment-button').classList.add('hidden');
